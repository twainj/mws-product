...
exports = module.exports = function(options) {
  ...
  mwsReqProcessor = function mwsReqProcessor(reqForm, name, responseKey, resultKey, errorCode) {
    var returnData,
        returnErr,
        mwsRes,
        reqErr,
  ...
  serviceStatus = function serviceStatus() {
    return mwsReqProcessor({query: {"Action": "GetServiceStatus"}}, 'serviceStatus', undefined, undefined, "mwsprod-003");
  };

  // Gets product info for the given Id list
  // idType: ASIN, GCID, SellerSKU, UPC, EAN, ISBN, and JAN
  matchingProductForId = function matchingProductForId(options) {
    ...
    return mwsReqProcessor(reqForm, 'matchingProductForId', "GetMatchingProductForIdResponse", "GetMatchingProductForIdResult", "mwsprod-004");
  };

  // Lists matching products for a given query string in a given context
  // TODO: provide a queryContextId lookup mechanism
  matchingProducts = function matchingProducts(options) {
    ...
    return mwsReqProcessor(reqForm, 'matchingProducts', "ListMatchingProductsResponse", "ListMatchingProductsResult", "mwsprod-005");
  };

  // Gets products and attributes for a given ASIN list
  matchingProduct = function matchingProduct(options) {
    ...
    return mwsReqProcessor(reqForm, 'matchingProduct', "GetMatchingProductResponse", "GetMatchingProductResult", "mwsprod-006");
  };

  // Gets competitive pricing for the given SKU list
  competitivePricingForSKU = function competitivePricingForSKU(options) {
    ...
    return mwsReqProcessor(reqForm, 'competitivePricingForSKU', "GetCompetitivePricingForSKUResponse", "GetCompetitivePricingForSKUResult", "mwsprod-007");
  };

  // Gets competitive pricing for the given ASIN list
  competitivePricingForASIN = function competitivePricingForASIN(options) {
    ...
    mwsReqParamFormatter(reqForm, 'ASINList.ASIN', asinList);
    return mwsReqProcessor(reqForm, 'competitivePricingForASIN', "GetCompetitivePricingForASINResponse", "GetCompetitivePricingForASINResult", "mwsprod-008");
  };
  ...
  lowestOfferListingsForSKU = function lowestOfferListingsForSKU(options) {
    ...
    mwsReqParamFormatter(reqForm, 'SellerSKUList.SellerSKU', skuList);
    return mwsReqProcessor(reqForm, 'lowestOfferListingsForSKU', "GetLowestOfferListingsForSKUResponse", "GetLowestOfferListingsForSKUResult", "mwsprod-009");
  };

  // Gets lowest offer listings for the given ASIN list
  // itemCondition: Any, New, Used, Collectible, Refurbished, Club - (optional - defaults to Any)
  lowestOfferListingsForASIN = function lowestOfferListingsForASIN(options) {
    ...
    mwsReqParamFormatter(reqForm, 'ASINList.ASIN', asinList);
    return mwsReqProcessor(reqForm, 'lowestOfferListingsForASIN', "GetLowestOfferListingsForASINResponse", "GetLowestOfferListingsForASINResult", "mwsprod-010");
  };

  // Gets seller's price for the given SKU list
  // itemCondition: Any, New, Used, Collectible, Refurbished, Club - (optional - defaults to Any)
  myPriceForSKU = function myPriceForSKU(options) {
    ...
    mwsReqParamFormatter(reqForm, 'SellerSKUList.SellerSKU', skuList);
    return mwsReqProcessor(reqForm, 'myPriceForSKU', "GetMyPriceForSKUResponse", "GetMyPriceForSKUResult", "mwsprod-011");
  };

  // Gets seller's price for the given ASIN list
  // itemCondition: Any, New, Used, Collectible, Refurbished, Club - (optional - defaults to Any)
  myPriceForASIN = function myPriceForASIN(options) {
    ...
    mwsReqParamFormatter(reqForm, 'ASINList.ASIN', asinList);
    return mwsReqProcessor(reqForm, 'myPriceForASIN', "GetMyPriceForASINResponse", "GetMyPriceForASINResult", "mwsprod-012");
  };

  // Returns parent categories for the given SKU
  productCategoriesForSKU = function productCategoriesForSKU(options) {
    ...
    return mwsReqProcessor(reqForm, 'productCategoriesForSKU', "GetProductCategoriesForSKUResponse", "GetProductCategoriesForSKUResult", "mwsprod-013");
  };

  // Returns parent categories for the given ASIN
  productCategoriesForASIN = function productCategoriesForASIN(options) {
    ...
    return mwsReqProcessor(reqForm, 'productCategoriesForASIN', "GetProductCategoriesForASINResponse", "GetProductCategoriesForASINResult", "mwsprod-014");
  };
